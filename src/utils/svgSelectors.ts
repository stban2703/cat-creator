...
export const shadowSelector = svgSelectors.shadow;
export const furOnlyStrokeSelector = svgSelectors.furOnlyStroke;
export const furFillAndStrokeSelector = svgSelectors.furFillAndStroke;
export const eyesFillSelector = svgSelectors.eyesFill;
export const linesPatternSelector = svgSelectors.linesPattern;
export const colorAndWhitePatternSelector = svgSelectors.colorAndWhitePattern;
export const siamesePatternSelector = svgSelectors.siamesePattern;
export const tricolorYellowSelector = svgSelectors.tricolorPatternYellow;
export const tricolorBlackSelector = svgSelectors.tricolorPatternBlack;
export const pupilContractedSelector = svgSelectors.pupilContracted;
export const pupilNormalSelector = svgSelectors.pupilNormal;
export const pupilExpandedSelector = svgSelectors.pupilExpanded;
export const baseNecklaceSelector = svgSelectors.baseNecklace;
export const roundNecklaceSelector = svgSelectors.roundNecklace;
export const heartNecklaceSelector = svgSelectors.heartNecklace;
export const ribbonNecklaceSelector = svgSelectors.ribbonNecklace;
export const necklaceTextSelector = svgSelectors.necklaceText;
export const topHatSelector = svgSelectors.topHatSelector;
export const partyHatSelector = svgSelectors.partyHatSelector;